...
var UnicodeBidiService = _interopDefault(require('fbjs/lib/UnicodeBidiService'));
var nullthrows = _interopDefault(require('fbjs/lib/nullthrows'));
var React = _interopDefault(require('react'));
var cx = _interopDefault(require('fbjs/lib/cx'));
var UserAgent = _interopDefault(require('fbjs/lib/UserAgent'));
var Keys = _interopDefault(require('fbjs/lib/Keys'));
var ReactDOM = _interopDefault(require('react-dom'));
var UnicodeBidi = _interopDefault(require('fbjs/lib/UnicodeBidi'));
var UnicodeBidiDirection = _interopDefault(require('fbjs/lib/UnicodeBidiDirection'));
var containsNode = _interopDefault(require('fbjs/lib/containsNode'));
var getActiveElement = _interopDefault(require('fbjs/lib/getActiveElement'));
var Scroll = _interopDefault(require('fbjs/lib/Scroll'));
var Style = _interopDefault(require('fbjs/lib/Style'));
var getElementPosition = _interopDefault(require('fbjs/lib/getElementPosition'));
var getScrollPosition = _interopDefault(require('fbjs/lib/getScrollPosition'));
var getViewportDimensions = _interopDefault(require('fbjs/lib/getViewportDimensions'));
var joinClasses = _interopDefault(require('fbjs/lib/joinClasses'));
var DataTransfer = _interopDefault(require('fbjs/lib/DataTransfer'));
var setImmediate = _interopDefault(require('fbjs/lib/setImmediate'));
var UnicodeUtils = _interopDefault(require('fbjs/lib/UnicodeUtils'));
var warning = _interopDefault(require('fbjs/lib/warning'));
var TokenizeUtil = _interopDefault(require('fbjs/lib/TokenizeUtil'));
var URI = _interopDefault(require('fbjs/lib/URI'));
...
var BlockMapBuilder = {
    createFromArray: function (blocks) {
        return immutable.OrderedMap(blocks.map(function (block) { return [block.getKey(), block]; }));
    }
};
 ...
 * @emails oncall+draft_js
 */
var EMPTY_SET = immutable.OrderedSet();
var defaultRecord = {
    style: EMPTY_SET,
    entity: null,
};
var CharacterMetadataRecord = immutable.Record(defaultRecord);
var CharacterMetadata = /** @class */ (function (_super) {
    ...
    CharacterMetadata.create = function (config) {
        ...
        var configMap = immutable.Map(defaultConfig).merge(config);
...
var pool = immutable.Map([
    [immutable.Map(defaultRecord), EMPTY],
]);
 ...
 * @emails oncall+draft_js
 */
var EMPTY_SET$1 = immutable.OrderedSet();
var defaultRecord$1 = {
    key: '',
    type: 'unstyled',
    text: '',
...
var ContentBlockRecord = immutable.Record(defaultRecord$1);
var decorateCharacterList = function (config) {
    ...
    if (text && !characterList) {
        config.characterList = immutable.List(immutable.Repeat(CharacterMetadata.EMPTY, text.length));
    }
    return config;
};
 ...
 */
var EMPTY_SET$2 = immutable.OrderedSet();
var defaultRecord$2 = {
    parent: null,
    characterList: immutable.List(),
    data: immutable.Map(),
...
}(immutable.Record(defaultRecord$2)));
...
var randomizeContentBlockNodeKeys = function (blockMap) {
    ...
    var lastRootBlock;
    return immutable.OrderedMap(blockMap
...
var randomizeContentBlockKeys = function (blockMap) {
    return immutable.OrderedMap(blockMap.toArray().map(function (block) {
        var key = generateRandomKey();
...
var updateBlockMapLinks = function (blockMap, originalBlockMap, targetBlock, fragmentHeadBlock) {
    return blockMap.withMutations(function (blockMapState) {
        ...
        if (targetParentKey) {
            ...
            blockMapState.setIn([targetParentKey, 'children'], immutable.List(newChildrenKeysArray));
        }
    });
};
...
function insertTextIntoContentState(contentState, selectionState, text, characterMetadata) {
    ...
    var newBlock = block.merge({
        ...
        characterList: insertIntoList(block.getCharacterList(), immutable.Repeat(characterMetadata, len).toList(), offset),
    });
...
var updateBlockMapLinks$2 = function (blockMap, originalBlock, belowBlock) {
    return blockMap.withMutations(function (blocks) {
        ...
        transformBlock$1(originalBlock.getParentKey(), blocks, function (block) {
            ...
            return block.merge({
                children: immutable.List(newChildrenArray),
            });
        });
...
var DraftModifier = {
    replaceText: function (contentState, rangeToReplace, text, inlineStyle, entityKey) {
        ...
        var character = CharacterMetadata.create({
            style: inlineStyle || immutable.OrderedSet(),
...
var LeafRange = immutable.Record(defaultLeafRange);
...
var DecoratorRange = immutable.Record(defaultDecoratorRange);
var BlockTree = {
    /**
    ...
    generate: function (contentState, block, decorator) {
        ...
        if (!textLength) {
            return immutable.List.of(new DecoratorRange({
                start: 0,
                end: 0,
                decoratorKey: null,
                leaves: immutable.List.of(new LeafRange({ start: 0, end: 0 })),
            }));
        }
        var leafSets = [];
        var decorations = decorator
            ? decorator.getDecorations(block, contentState)
            : immutable.List(immutable.Repeat(null, textLength));
        var chars = block.getCharacterList();
        ...
        return immutable.List(leafSets);
    },
};
/**
 ...
 * @emails oncall+draft_js
 */
var DraftEntityInstanceRecord = immutable.Record({
    type: 'TOKEN',
...
var SelectionStateRecord = immutable.Record(defaultRecord$3);
...
var ContentStateRecord = immutable.Record(defaultRecord$4);
    ...
    ContentState.createFromText = function (text, delimiter) {
        ...
        var blocks = strings.map(function (block) {
            ...
            return new ContentBlockNodeRecord({
                ...
                text: block,
                type: 'unstyled',
                characterList: immutable.List(immutable.Repeat(CharacterMetadata.EMPTY, block.length)),
            });
        });
...
var EditorBidiService = {
    getDirectionMap: function (content, prevBidiMap) {
        ...
        var bidiMap = immutable.OrderedMap(blockMap.keySeq().zip(nextBidi));
...
var EditorStateRecord = immutable.Record(defaultRecord$5);
...
var moveBlockInContentState = function (contentState, blockToBeMoved, targetBlock, insertionMode) {
    ...
    var newBlocks = immutable.OrderedMap();
...
var AtomicBlockUtils = {
    insertAtomicBlock: function (editorState, entityKey, character) {
        ...
        var atomicBlockConfig = {
            ...
            type: 'atomic',
            text: character,
            characterList: immutable.List(immutable.Repeat(charData, character.length)),
        };
...
var knownListItemDepthClasses = (_a = {},
    ...
    _a);
var HTMLTagToRawInlineStyleMap = immutable.Map({
    b: 'BOLD',
    code: 'CODE',
    del: 'STRIKETHROUGH',
    em: 'ITALIC',
...
var buildBlockTypeMap = function (blockRenderMap) {
    ...
    return immutable.Map(blockTypeMap);
};
/**
...
var styleFromNodeAttributes = function (node) {
    var style = immutable.OrderedSet();
...
var ContentBlocksBuilder = /** @class */ (function () {
    function ContentBlocksBuilder(blockTypeMap, disambiguate) {
        ...
        this.characterList = immutable.List();
        this.currentBlockType = 'unstyled';
        this.currentDepth = 0;
        this.currentEntity = null;
        this.currentStyle = immutable.OrderedSet();
        this.currentText = '';
        this.wrapper = null;
    ...
    ContentBlocksBuilder.prototype._makeBlockConfig = function (config) {
        ...
        var block = __assign({ key: key, type: this.currentBlockType, text: this.currentText, characterList: this.characterList, depth: this.currentDepth, parent: null, children: immutable.List(), prevSibling: null, nextSibling: null, childConfigs: [] }, config);
        this.characterList = immutable.List();
        this.currentBlockType = 'unstyled';
        this.currentText = '';
        return block;
    ...
    ContentBlocksBuilder.prototype._toBlockConfigs = function (nodes) {
        ...
        for (var i = 0; i < nodes.length; i++) {
            ...
            var inlineStyle = HTMLTagToRawInlineStyleMap.has(nodeName)
                ? immutable.OrderedSet.of(HTMLTagToRawInlineStyleMap.get(nodeName))
    ...
    ContentBlocksBuilder.prototype._toContentBlocks = function (blockConfigs, parent) {
        ...
        for (var i = 0; i <= l; i++) {
            ...
            config.children = immutable.List(config.childConfigs.map(function (child) { return child.key; }));
    ...
    ContentBlocksBuilder.prototype._hoistContainersInBlockConfigs = function (blockConfigs) {
        var _this = this;
        var hoisted = immutable.List(blockConfigs).flatMap(function (blockConfig) {
    ...
    ContentBlocksBuilder.prototype._extractTextFromBlockConfigs = function (blockConfigs) {
        var l = blockConfigs.length - 1;
        var text = '';
        var characterList = immutable.List();
        for (var i = 0; i <= l; i++) {
            var config = blockConfigs[i];
            text += config.text;
    ...
    processText: function (textBlocks, character, type) {
        return textBlocks.reduce(function (acc, textLine, index) {
            ...
            var blockNodeConfig = {
                ...
                type: type,
                text: textLine,
                characterList: immutable.List(immutable.Repeat(character, textLine.length))
            };
...
function createCharacterList(inlineStyles, entities) {
    ...
    return immutable.List(characterArray);
}
...
var EMPTY_SET$3 = immutable.OrderedSet();
/**
 * Convert to native JavaScript string lengths to determine ranges.
 */
...
var decodeContentBlockNodes = function (blocks, entityMap) {
    return (blocks
        ...
        // root level nodes
        var contentBlockNode = new ContentBlockNode(__assign(__assign({}, decodeBlockNodeConfig(block, entityMap)), { prevSibling: index === 0 ? null : blocks[index - 1].key, nextSibling: index === blocks.length - 1 ? null : blocks[index + 1].key, children: immutable.List(children.map(function (child) { return child.key; })) }));
        ...
        while (stack.length > 0) {
            ...
            var contentBlockNode_1 = new ContentBlockNode(__assign(__assign({}, decodeBlockNodeConfig(node, entityMap)), { parent: parentRef.getKey(), children: immutable.List(children_1.map(function (child) { return child.key; })), prevSibling: index_1 === 0 ? null : siblings.get(index_1 - 1), nextSibling: index_1 === siblings.size - 1 ? null : siblings.get(index_1 + 1) }));
...
var decodeContentBlocks = function (blocks, entityMap) {
    return immutable.OrderedMap(blocks.map(function (block) {
...
exports.AtomicBlockUtils = AtomicBlockUtils;
exports.BlockMapBuilder = BlockMapBuilder;
exports.CharacterMetadata = CharacterMetadata;
exports.CompositeDecorator = CompositeDraftDecorator;
exports.ContentBlock = ContentBlock;
exports.ContentState = ContentState;
exports.DefaultDraftBlockRenderMap = DefaultDraftBlockRenderMap;
exports.DefaultDraftInlineStyle = DefaultDraftInlineStyle;
exports.DraftEditor = DraftEditor;
exports.Editor = DraftEditor;
exports.EditorBlock = DraftEditorBlock;
exports.EditorState = EditorState;
exports.Entity = DraftEntity;
exports.EntityInstance = DraftEntityInstance;
exports.KeyBindingUtil = KeyBindingUtil;
exports.Modifier = DraftModifier;
exports.RawDraftContentState = RawDraftContentState;
exports.RichUtils = RichTextEditorUtil;
exports.SelectionState = SelectionState;
exports.convertFromHTML = convertFromHTMLToContentBlocks;
exports.convertFromRaw = convertFromRawToDraftState;
exports.convertToRaw = convertFromDraftStateToRaw;
exports.genKey = generateRandomKey;
exports.getDefaultKeyBinding = getDefaultKeyBinding;
exports.getVisibleSelectionRect = getVisibleSelectionRect;
